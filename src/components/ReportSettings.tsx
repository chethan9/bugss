...
export interface ReportConfig {
  ...
  logoUrl: string;
  reportTitle: string;
  confidentialityLevel: "public" | "internal" | "confidential" | "none";
...
export const DEFAULT_REPORT_CONFIG: ReportConfig = {
  ...
  showTimestamp: true,
  footerText: "Generated by Issue Dashboard",
...
export function ReportSettings({ config, onConfigChange }: ReportSettingsProps) {
  ...
  const handleLogoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        setLocalConfig({ ...localConfig, logoUrl: e.target?.result as string });
      };
